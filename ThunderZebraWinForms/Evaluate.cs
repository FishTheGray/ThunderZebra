...
namespace ThunderZebraWinForms
{
    class Evaluate
    {
        ...
        // 五:1000000 活四:750000 死四:600000 真活三:350000 假活三:400000
        ...
        int[] value = { 1000, 2500, 5000, 50000, 100000, 350000, 300000, 200000, 300000, 750000, 1000000, 100 ,450000};
        //int[] value = { 15, 20, 200, 20, 200, 350000, 340000, 600000, 350000, 750000, int.MaxValue, 10 , 350000 };
        //               死二,冲二,活二,死三,冲三,活三, 跳三,  死四,    冲四,   活四,五,堵活三
        ...
        int calc(int[,] chessboard , int step)
        {
            ...
            //堵活三奖励
            vb.Add(new int[] { 2, 1, 1, 1 });
            vb.Add(new int[] { 1, 1, 1, 2 });
            try
            {
                checked
                {
                    ...
                    sb += value[12] * i.shapeCampare(vb[21]);
            ...
            //System.Diagnostics.Debug.WriteLine("当前黑方分数为{0}", sb);
            ...
            vw.Add(new int[] { 2, 1, 1, 1 });
            vw.Add(new int[] { 1, 1, 1, 2 });
            try
            {
                checked
                {
                    ...
                    sw += value[12] * i.shapeCampare(vw[21]);
                    //sw *= 9;
                    //sw /= 10;
                }
            }
            catch (OverflowException)
            {
                ...
                //System.Windows.Forms.MessageBox.Show("白溢出");

            }

            //System.Diagnostics.Debug.WriteLine("当前白方分数为{0}", sw);
